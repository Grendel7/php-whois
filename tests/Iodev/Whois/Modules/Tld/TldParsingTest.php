...
class TldParsingTest extends TestCase
{
    ...
    public function getTestData()
    {
        ...
        return $resolveKeys([
            ...
            // .CAFE
            [ "free.cafe", ".cafe/free.txt", null ],
            [ "nic.cafe", ".cafe/nic.cafe.txt", ".cafe/nic.cafe.json" ],
            ...
            // .JEWELRY
            [ "free.jewelry", ".jewelry/free.txt", null ],
            [ "microsoft.jewelry", ".jewelry/microsoft.jewelry.txt", ".jewelry/microsoft.jewelry.json" ],
